...
//                }
                ...
                try {
                    mWebSocketClient.send("SendMessageServer+"+UserId+"+"+id_order+"+"+messageText);
...
//        chatHistory.add(msg1;)
        ...
        adapter = new ChatAdapter(ChatDriverActivity.this, new ArrayList<ChatMessage>());
    ...
    private void connectWebSocket(String $id_user) {
        ...
        mWebSocketClient = new WebSocketClient(uri, new Draft_17()) {
            ...
            public void onOpen(ServerHandshake serverHandshake) {
                ...
                try {
                    conditionConnect = 1;
                    mWebSocketClient.send("FetchMessageServer+" + $Userid + "+" + id_order);
                }
                catch (Exception e){
...
//                Toast.makeText(ChatDriverActivity.this, message, Toast.LENGTH_LONG).show();
